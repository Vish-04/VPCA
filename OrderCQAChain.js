...
//Get Order Chain
const getOrderAnswerTemplate = `Your job is to repeat the order back to the customer as a restaurant worker at an indian cusine when given the customers question and Order below. Ensure that you respond with the order of the item, quantity, and any notes/modifications (if there are none dont mention modifications) one by one keeping it short. At the end mention the total combined price of the entire order. If there is no order state that there is none. The order consists of the following format where multiple menu items are seperated by commas in the same format Ex: Mango Lassi, $4.49, 1, none, Vegetable Pakora, $3.99, 2, extra spicy. Remove fluff and keep your answer short without excluding information.
